...
def load_data():
    ...
    # Priority Check: Look for the specific Top 20 file first, then fallback to general file
    ...
    if selected_file:
        try:
            ...
            # Map new file columns to App Standards if necessary
            # This ensures 'Drug' becomes 'Name' and 'Drug Class' becomes 'Class'
            rename_map = {
                "Drug": "Name",
                "Drug Class": "Class",
                "Dosage (mg)": "Dose"
        ...
        st.warning(
            "⚠️ No data file found (checked for 'top_20_antihypertensive.xlsx' and 'drug_data.xlsx'). Displaying mock data.")
